...
public class UtilRelatorios {
    ...
    public static void imprimeRelatorio(String nomeRelatorio, HashMap parametros, List lista) {
        try {
            ...
            JasperPrint jasperPrint = JasperFillManager.fillReport(scontext.getRealPath("/WEB-INF/relatorios/") + nomeRelatorio + ".jasper", parametros, dataSource);
            ...
            System.out.println("Erro ao imprimir relatório " + Util.getMensagemErrom(e));
            e.printStackTrace();
        }
    }
}
